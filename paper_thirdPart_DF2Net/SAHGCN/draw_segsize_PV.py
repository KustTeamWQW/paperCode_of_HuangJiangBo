...
S2HGCN_results = [0.88405967,0.8549125,0.84186196,0.7975789,0.7524993]
S2HGCN_results=np.array(S2HGCN_results) * 100
AdvFNet_results = [0.9305451,0.94194937,0.93854266,0.94509524,0.9325836]
...
plt.savefig("seg_seize_PV"+ '.png', format='png', transparent=True, dpi=400)
# 顯示折綫圖
plt.show()