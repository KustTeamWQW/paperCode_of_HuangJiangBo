...
# 畫出折綫圖
plt.plot(sample_ratios, cnn_results, marker='*', color=(46/255, 117/255, 182 / 255),linestyle='--',linewidth=3, markersize=8,label='CNN')
...
# 添加圖例
plt.legend()
plt.savefig("CNN_GCN"+ '.png', format='png', transparent=True, dpi=400)
# 顯示折綫圖
plt.show()