...
def readData(data_set_name):
    ...
    if data_set_name=="DC":
        img = np.load(r"D:\dataset\DianChi\DCdatasetsmall\HSIDC.npy")
        gt = np.load(r"D:\dataset\DianChi\DCdatasetsmall\LabelDC.npy")
    if data_set_name == "WHU":
        img = scio.loadmat(r'D:\dataset\WHU-Hi-HongHu\WHU_Hi_HongHu.mat')["WHU_Hi_HongHu"]
        gt = scio.loadmat(r'D:\dataset\WHU-Hi-HongHu\WHU_Hi_HongHu_gt.mat')["WHU_Hi_HongHu_gt"]
        img=img[450:,:,:]
        gt=gt[450:,:]
        gt[gt > 5] -= 1
    if data_set_name == "WHUL":
        img = scio.loadmat(r'D:\dataset\WHU-Hi-LongKou\WHU_Hi_LongKou.mat')["WHU_Hi_LongKou"]
        gt = scio.loadmat(r'D:\dataset\WHU-Hi-LongKou\WHU_Hi_LongKou_gt.mat')["WHU_Hi_LongKou_gt"]
